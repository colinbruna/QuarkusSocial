...
import com.brunasilva.quarkussocial.rest.dto.FollowerResponse;
import com.brunasilva.quarkussocial.rest.dto.FollowersPerUserResponse;
...
public class FollowerResource {
    ...
    public Response listFollowers(@PathParam("userId") Long userId) {
        ...
        var followerList = list.stream()
                ...
                //esse map esta mapeando um objeto da lista do tipo follower para um objeto do tipo follower response
